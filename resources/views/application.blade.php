...
<head>
  <meta charset="UTF-8" />
  @php
    $faviconImg = \App\Models\ImagenSistema::obtenerActiva(\App\Models\ImagenSistema::USO_FAVICON);
    $faviconHref = $faviconImg ? Illuminate\Support\Facades\Storage::url($faviconImg->ruta) : asset('favicon.ico');
  @endphp
  ...
  <div id="app">
    <div id="loading-bg">
      <div class="loading-logo">
        @php
          $loaderImg = \App\Models\ImagenSistema::obtenerActiva(\App\Models\ImagenSistema::USO_LOADER);
        @endphp

        @if($loaderImg)
          @php $loaderHref = Illuminate\Support\Facades\Storage::url($loaderImg->ruta); @endphp
          <img src="{{ $loaderHref }}" alt="loader" style="max-width:200px;max-height:200px;" />
        @else
          <!-- SVG Logo (fallback) -->
